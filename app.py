...
# ─── Config ───────────────────────────────────────────────────────
FACE_DATA_PATH = os.environ.get("FACE_DATA_PATH", "face_data/encodings.pkl")
DB_PATH = os.environ.get("DATABASE_URL", "sqlite:///database/attendance.db")

# Email config – read from environment variables
EMAIL_CONFIG = {
